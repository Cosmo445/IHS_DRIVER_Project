...
module pcihellocore_mm_interconnect_0 (
	...
	wire          cmd_mux_005_src_valid;                                                  // cmd_mux_005:src_valid -> pcie_hard_ip_0_txs_agent:cp_valid
	wire  [148:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> pcie_hard_ip_0_txs_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                  // pcie_hard_ip_0_txs_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> pcie_hard_ip_0_txs_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                          // cmd_mux_005:src_startofpacket -> pcie_hard_ip_0_txs_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                            // cmd_mux_005:src_endofpacket -> pcie_hard_ip_0_txs_agent:cp_endofpacket
	...
	wire          pcie_hard_ip_0_txs_agent_rp_valid;                                      // pcie_hard_ip_0_txs_agent:rp_valid -> router_006:sink_valid
	wire  [148:0] pcie_hard_ip_0_txs_agent_rp_data;                                       // pcie_hard_ip_0_txs_agent:rp_data -> router_006:sink_data
	wire          pcie_hard_ip_0_txs_agent_rp_ready;                                      // router_006:sink_ready -> pcie_hard_ip_0_txs_agent:rp_ready
	wire          pcie_hard_ip_0_txs_agent_rp_startofpacket;                              // pcie_hard_ip_0_txs_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          pcie_hard_ip_0_txs_agent_rp_endofpacket;                                // pcie_hard_ip_0_txs_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [5:0] router_src_channel;                                                     // router:src_channel -> pcie_hard_ip_0_bar0_limiter:cmd_sink_channel
	...
	wire    [5:0] pcie_hard_ip_0_bar0_limiter_cmd_src_channel;                            // pcie_hard_ip_0_bar0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [5:0] rsp_mux_src_channel;                                                    // rsp_mux:src_channel -> pcie_hard_ip_0_bar0_limiter:rsp_sink_channel
	...
	wire    [5:0] pcie_hard_ip_0_bar0_limiter_rsp_src_channel;                            // pcie_hard_ip_0_bar0_limiter:rsp_src_channel -> pcie_hard_ip_0_bar0_agent:rp_channel
	...
	wire    [5:0] pcie_hard_ip_0_cra_burst_adapter_source0_channel;                       // pcie_hard_ip_0_cra_burst_adapter:source0_channel -> pcie_hard_ip_0_cra_agent:cp_channel
	...
	wire    [5:0] inport_s1_burst_adapter_source0_channel;                                // inport_s1_burst_adapter:source0_channel -> inport_s1_agent:cp_channel
	...
	wire    [5:0] hexport_s1_burst_adapter_source0_channel;                               // hexport_s1_burst_adapter:source0_channel -> hexport_s1_agent:cp_channel
	...
	wire    [5:0] ledsgreenport_s1_burst_adapter_source0_channel;                         // ledsgreenport_s1_burst_adapter:source0_channel -> ledsgreenport_s1_agent:cp_channel
	...
	wire    [5:0] ledsredport_s1_burst_adapter_source0_channel;                           // ledsredport_s1_burst_adapter:source0_channel -> ledsredport_s1_agent:cp_channel
	...
	wire    [5:0] router_001_src_channel;                                                 // router_001:src_channel -> pcie_hard_ip_0_cra_rsp_width_adapter:in_channel
	...
	wire    [5:0] pcie_hard_ip_0_cra_rsp_width_adapter_src_channel;                       // pcie_hard_ip_0_cra_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire    [5:0] router_002_src_channel;                                                 // router_002:src_channel -> inport_s1_rsp_width_adapter:in_channel
	...
	wire    [5:0] inport_s1_rsp_width_adapter_src_channel;                                // inport_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire    [5:0] router_003_src_channel;                                                 // router_003:src_channel -> hexport_s1_rsp_width_adapter:in_channel
	...
	wire    [5:0] hexport_s1_rsp_width_adapter_src_channel;                               // hexport_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire    [5:0] router_004_src_channel;                                                 // router_004:src_channel -> ledsgreenport_s1_rsp_width_adapter:in_channel
	...
	wire    [5:0] ledsgreenport_s1_rsp_width_adapter_src_channel;                         // ledsgreenport_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire    [5:0] router_005_src_channel;                                                 // router_005:src_channel -> ledsredport_s1_rsp_width_adapter:in_channel
	...
	wire    [5:0] ledsredport_s1_rsp_width_adapter_src_channel;                           // ledsredport_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire    [5:0] cmd_mux_src_channel;                                                    // cmd_mux:src_channel -> pcie_hard_ip_0_cra_cmd_width_adapter:in_channel
	...
	wire    [5:0] pcie_hard_ip_0_cra_cmd_width_adapter_src_channel;                       // pcie_hard_ip_0_cra_cmd_width_adapter:out_channel -> pcie_hard_ip_0_cra_burst_adapter:sink0_channel
	...
	wire    [5:0] cmd_mux_001_src_channel;                                                // cmd_mux_001:src_channel -> inport_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] inport_s1_cmd_width_adapter_src_channel;                                // inport_s1_cmd_width_adapter:out_channel -> inport_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] cmd_mux_002_src_channel;                                                // cmd_mux_002:src_channel -> hexport_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] hexport_s1_cmd_width_adapter_src_channel;                               // hexport_s1_cmd_width_adapter:out_channel -> hexport_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> ledsgreenport_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] ledsgreenport_s1_cmd_width_adapter_src_channel;                         // ledsgreenport_s1_cmd_width_adapter:out_channel -> ledsgreenport_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> ledsredport_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] ledsredport_s1_cmd_width_adapter_src_channel;                           // ledsredport_s1_cmd_width_adapter:out_channel -> ledsredport_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] pcie_hard_ip_0_bar0_limiter_cmd_valid_data;                             // pcie_hard_ip_0_bar0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	wire          pcie_hard_ip_0_txs_agent_rdata_fifo_src_valid;                          // pcie_hard_ip_0_txs_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [65:0] pcie_hard_ip_0_txs_agent_rdata_fifo_src_data;                           // pcie_hard_ip_0_txs_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          pcie_hard_ip_0_txs_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_005:in_0_ready -> pcie_hard_ip_0_txs_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                      // avalon_st_adapter_005:out_0_valid -> pcie_hard_ip_0_txs_agent:rdata_fifo_sink_valid
	wire   [65:0] avalon_st_adapter_005_out_0_data;                                       // avalon_st_adapter_005:out_0_data -> pcie_hard_ip_0_txs_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                      // pcie_hard_ip_0_txs_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                      // avalon_st_adapter_005:out_0_error -> pcie_hard_ip_0_txs_agent:rdata_fifo_sink_error
	...
	pcihellocore_mm_interconnect_0_router_006 router_006 (
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (66),
		.inUsePackets    (0),
		.inDataWidth     (66),
		.inChannelWidth  (0),
