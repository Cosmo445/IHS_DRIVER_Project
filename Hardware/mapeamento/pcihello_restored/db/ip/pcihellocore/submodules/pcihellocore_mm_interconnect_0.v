...
module pcihellocore_mm_interconnect_0 (
	...
	wire    [8:0] hexrport_s1_burst_adapter_source0_channel;                              // hexrport_s1_burst_adapter:source0_channel -> hexrport_s1_agent:cp_channel
	...
	wire    [8:0] ledsgreenport_s1_burst_adapter_source0_channel;                         // ledsgreenport_s1_burst_adapter:source0_channel -> ledsgreenport_s1_agent:cp_channel
	...
	wire    [8:0] ledsredport_s1_burst_adapter_source0_channel;                           // ledsredport_s1_burst_adapter:source0_channel -> ledsredport_s1_agent:cp_channel
	...
	wire    [8:0] swport_s1_burst_adapter_source0_channel;                                // swport_s1_burst_adapter:source0_channel -> swport_s1_agent:cp_channel
	...
	wire    [8:0] keysport_s1_burst_adapter_source0_channel;                              // keysport_s1_burst_adapter:source0_channel -> keysport_s1_agent:cp_channel
	...
	wire    [8:0] hexlport_s1_burst_adapter_source0_channel;                              // hexlport_s1_burst_adapter:source0_channel -> hexlport_s1_agent:cp_channel
	...
	wire    [8:0] lcdport_s1_burst_adapter_source0_channel;                               // lcdport_s1_burst_adapter:source0_channel -> lcdport_s1_agent:cp_channel
	...
	wire    [8:0] router_002_src_channel;                                                 // router_002:src_channel -> hexrport_s1_rsp_width_adapter:in_channel
	...
	wire    [8:0] hexrport_s1_rsp_width_adapter_src_channel;                              // hexrport_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire    [8:0] router_003_src_channel;                                                 // router_003:src_channel -> ledsgreenport_s1_rsp_width_adapter:in_channel
	...
	wire    [8:0] ledsgreenport_s1_rsp_width_adapter_src_channel;                         // ledsgreenport_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire    [8:0] router_004_src_channel;                                                 // router_004:src_channel -> ledsredport_s1_rsp_width_adapter:in_channel
	...
	wire    [8:0] ledsredport_s1_rsp_width_adapter_src_channel;                           // ledsredport_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire    [8:0] router_005_src_channel;                                                 // router_005:src_channel -> swport_s1_rsp_width_adapter:in_channel
	...
	wire    [8:0] swport_s1_rsp_width_adapter_src_channel;                                // swport_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire    [8:0] router_006_src_channel;                                                 // router_006:src_channel -> keysport_s1_rsp_width_adapter:in_channel
	...
	wire    [8:0] keysport_s1_rsp_width_adapter_src_channel;                              // keysport_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire    [8:0] router_007_src_channel;                                                 // router_007:src_channel -> hexlport_s1_rsp_width_adapter:in_channel
	...
	wire    [8:0] hexlport_s1_rsp_width_adapter_src_channel;                              // hexlport_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	...
	wire    [8:0] router_008_src_channel;                                                 // router_008:src_channel -> lcdport_s1_rsp_width_adapter:in_channel
	...
	wire    [8:0] lcdport_s1_rsp_width_adapter_src_channel;                               // lcdport_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	...
	wire    [8:0] cmd_mux_001_src_channel;                                                // cmd_mux_001:src_channel -> hexrport_s1_cmd_width_adapter:in_channel
	...
	wire    [8:0] hexrport_s1_cmd_width_adapter_src_channel;                              // hexrport_s1_cmd_width_adapter:out_channel -> hexrport_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] cmd_mux_002_src_channel;                                                // cmd_mux_002:src_channel -> ledsgreenport_s1_cmd_width_adapter:in_channel
	...
	wire    [8:0] ledsgreenport_s1_cmd_width_adapter_src_channel;                         // ledsgreenport_s1_cmd_width_adapter:out_channel -> ledsgreenport_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> ledsredport_s1_cmd_width_adapter:in_channel
	...
	wire    [8:0] ledsredport_s1_cmd_width_adapter_src_channel;                           // ledsredport_s1_cmd_width_adapter:out_channel -> ledsredport_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> swport_s1_cmd_width_adapter:in_channel
	...
	wire    [8:0] swport_s1_cmd_width_adapter_src_channel;                                // swport_s1_cmd_width_adapter:out_channel -> swport_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> keysport_s1_cmd_width_adapter:in_channel
	...
	wire    [8:0] keysport_s1_cmd_width_adapter_src_channel;                              // keysport_s1_cmd_width_adapter:out_channel -> keysport_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> hexlport_s1_cmd_width_adapter:in_channel
	...
	wire    [8:0] hexlport_s1_cmd_width_adapter_src_channel;                              // hexlport_s1_cmd_width_adapter:out_channel -> hexlport_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] cmd_mux_007_src_channel;                                                // cmd_mux_007:src_channel -> lcdport_s1_cmd_width_adapter:in_channel
	...
	wire    [8:0] lcdport_s1_cmd_width_adapter_src_channel;                               // lcdport_s1_cmd_width_adapter:out_channel -> lcdport_s1_burst_adapter:sink0_channel
