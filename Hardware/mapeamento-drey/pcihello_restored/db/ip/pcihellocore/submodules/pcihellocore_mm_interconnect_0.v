...
module pcihellocore_mm_interconnect_0 (
		...
		input  wire        sw07port_reset_reset_bridge_in_reset_reset, // sw07port_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  sw07port_s1_address,                        //                          sw07port_s1.address
		input  wire [31:0] sw07port_s1_readdata,                       //                                     .readdata
		output wire [1:0]  sw15port_s1_address,                        //                          sw15port_s1.address
		input  wire [31:0] sw15port_s1_readdata                        //                                     .readdata
	);
	...
	wire   [31:0] sw07port_s1_agent_m0_readdata;                                          // sw07port_s1_translator:uav_readdata -> sw07port_s1_agent:m0_readdata
	wire          sw07port_s1_agent_m0_waitrequest;                                       // sw07port_s1_translator:uav_waitrequest -> sw07port_s1_agent:m0_waitrequest
	wire          sw07port_s1_agent_m0_debugaccess;                                       // sw07port_s1_agent:m0_debugaccess -> sw07port_s1_translator:uav_debugaccess
	wire   [31:0] sw07port_s1_agent_m0_address;                                           // sw07port_s1_agent:m0_address -> sw07port_s1_translator:uav_address
	wire    [3:0] sw07port_s1_agent_m0_byteenable;                                        // sw07port_s1_agent:m0_byteenable -> sw07port_s1_translator:uav_byteenable
	wire          sw07port_s1_agent_m0_read;                                              // sw07port_s1_agent:m0_read -> sw07port_s1_translator:uav_read
	wire          sw07port_s1_agent_m0_readdatavalid;                                     // sw07port_s1_translator:uav_readdatavalid -> sw07port_s1_agent:m0_readdatavalid
	wire          sw07port_s1_agent_m0_lock;                                              // sw07port_s1_agent:m0_lock -> sw07port_s1_translator:uav_lock
	wire   [31:0] sw07port_s1_agent_m0_writedata;                                         // sw07port_s1_agent:m0_writedata -> sw07port_s1_translator:uav_writedata
	wire          sw07port_s1_agent_m0_write;                                             // sw07port_s1_agent:m0_write -> sw07port_s1_translator:uav_write
	wire    [2:0] sw07port_s1_agent_m0_burstcount;                                        // sw07port_s1_agent:m0_burstcount -> sw07port_s1_translator:uav_burstcount
	wire          sw07port_s1_agent_rf_source_valid;                                      // sw07port_s1_agent:rf_source_valid -> sw07port_s1_agent_rsp_fifo:in_valid
	wire  [113:0] sw07port_s1_agent_rf_source_data;                                       // sw07port_s1_agent:rf_source_data -> sw07port_s1_agent_rsp_fifo:in_data
	wire          sw07port_s1_agent_rf_source_ready;                                      // sw07port_s1_agent_rsp_fifo:in_ready -> sw07port_s1_agent:rf_source_ready
	wire          sw07port_s1_agent_rf_source_startofpacket;                              // sw07port_s1_agent:rf_source_startofpacket -> sw07port_s1_agent_rsp_fifo:in_startofpacket
	wire          sw07port_s1_agent_rf_source_endofpacket;                                // sw07port_s1_agent:rf_source_endofpacket -> sw07port_s1_agent_rsp_fifo:in_endofpacket
	wire          sw07port_s1_agent_rsp_fifo_out_valid;                                   // sw07port_s1_agent_rsp_fifo:out_valid -> sw07port_s1_agent:rf_sink_valid
	wire  [113:0] sw07port_s1_agent_rsp_fifo_out_data;                                    // sw07port_s1_agent_rsp_fifo:out_data -> sw07port_s1_agent:rf_sink_data
	wire          sw07port_s1_agent_rsp_fifo_out_ready;                                   // sw07port_s1_agent:rf_sink_ready -> sw07port_s1_agent_rsp_fifo:out_ready
	wire          sw07port_s1_agent_rsp_fifo_out_startofpacket;                           // sw07port_s1_agent_rsp_fifo:out_startofpacket -> sw07port_s1_agent:rf_sink_startofpacket
	wire          sw07port_s1_agent_rsp_fifo_out_endofpacket;                             // sw07port_s1_agent_rsp_fifo:out_endofpacket -> sw07port_s1_agent:rf_sink_endofpacket
	...
	wire   [31:0] sw15port_s1_agent_m0_readdata;                                          // sw15port_s1_translator:uav_readdata -> sw15port_s1_agent:m0_readdata
	wire          sw15port_s1_agent_m0_waitrequest;                                       // sw15port_s1_translator:uav_waitrequest -> sw15port_s1_agent:m0_waitrequest
	wire          sw15port_s1_agent_m0_debugaccess;                                       // sw15port_s1_agent:m0_debugaccess -> sw15port_s1_translator:uav_debugaccess
	wire   [31:0] sw15port_s1_agent_m0_address;                                           // sw15port_s1_agent:m0_address -> sw15port_s1_translator:uav_address
	wire    [3:0] sw15port_s1_agent_m0_byteenable;                                        // sw15port_s1_agent:m0_byteenable -> sw15port_s1_translator:uav_byteenable
	wire          sw15port_s1_agent_m0_read;                                              // sw15port_s1_agent:m0_read -> sw15port_s1_translator:uav_read
	wire          sw15port_s1_agent_m0_readdatavalid;                                     // sw15port_s1_translator:uav_readdatavalid -> sw15port_s1_agent:m0_readdatavalid
	wire          sw15port_s1_agent_m0_lock;                                              // sw15port_s1_agent:m0_lock -> sw15port_s1_translator:uav_lock
	wire   [31:0] sw15port_s1_agent_m0_writedata;                                         // sw15port_s1_agent:m0_writedata -> sw15port_s1_translator:uav_writedata
	wire          sw15port_s1_agent_m0_write;                                             // sw15port_s1_agent:m0_write -> sw15port_s1_translator:uav_write
	wire    [2:0] sw15port_s1_agent_m0_burstcount;                                        // sw15port_s1_agent:m0_burstcount -> sw15port_s1_translator:uav_burstcount
	wire          sw15port_s1_agent_rf_source_valid;                                      // sw15port_s1_agent:rf_source_valid -> sw15port_s1_agent_rsp_fifo:in_valid
	wire  [113:0] sw15port_s1_agent_rf_source_data;                                       // sw15port_s1_agent:rf_source_data -> sw15port_s1_agent_rsp_fifo:in_data
	wire          sw15port_s1_agent_rf_source_ready;                                      // sw15port_s1_agent_rsp_fifo:in_ready -> sw15port_s1_agent:rf_source_ready
	wire          sw15port_s1_agent_rf_source_startofpacket;                              // sw15port_s1_agent:rf_source_startofpacket -> sw15port_s1_agent_rsp_fifo:in_startofpacket
	wire          sw15port_s1_agent_rf_source_endofpacket;                                // sw15port_s1_agent:rf_source_endofpacket -> sw15port_s1_agent_rsp_fifo:in_endofpacket
	wire          sw15port_s1_agent_rsp_fifo_out_valid;                                   // sw15port_s1_agent_rsp_fifo:out_valid -> sw15port_s1_agent:rf_sink_valid
	wire  [113:0] sw15port_s1_agent_rsp_fifo_out_data;                                    // sw15port_s1_agent_rsp_fifo:out_data -> sw15port_s1_agent:rf_sink_data
	wire          sw15port_s1_agent_rsp_fifo_out_ready;                                   // sw15port_s1_agent:rf_sink_ready -> sw15port_s1_agent_rsp_fifo:out_ready
	wire          sw15port_s1_agent_rsp_fifo_out_startofpacket;                           // sw15port_s1_agent_rsp_fifo:out_startofpacket -> sw15port_s1_agent:rf_sink_startofpacket
	wire          sw15port_s1_agent_rsp_fifo_out_endofpacket;                             // sw15port_s1_agent_rsp_fifo:out_endofpacket -> sw15port_s1_agent:rf_sink_endofpacket
	...
	wire          sw07port_s1_agent_rp_valid;                                             // sw07port_s1_agent:rp_valid -> router_002:sink_valid
	wire  [112:0] sw07port_s1_agent_rp_data;                                              // sw07port_s1_agent:rp_data -> router_002:sink_data
	wire          sw07port_s1_agent_rp_ready;                                             // router_002:sink_ready -> sw07port_s1_agent:rp_ready
	wire          sw07port_s1_agent_rp_startofpacket;                                     // sw07port_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          sw07port_s1_agent_rp_endofpacket;                                       // sw07port_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire          hexrport_s1_agent_rp_valid;                                             // hexrport_s1_agent:rp_valid -> router_003:sink_valid
	wire  [112:0] hexrport_s1_agent_rp_data;                                              // hexrport_s1_agent:rp_data -> router_003:sink_data
	wire          hexrport_s1_agent_rp_ready;                                             // router_003:sink_ready -> hexrport_s1_agent:rp_ready
	wire          hexrport_s1_agent_rp_startofpacket;                                     // hexrport_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          hexrport_s1_agent_rp_endofpacket;                                       // hexrport_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	wire          sw15port_s1_agent_rp_valid;                                             // sw15port_s1_agent:rp_valid -> router_004:sink_valid
	wire  [112:0] sw15port_s1_agent_rp_data;                                              // sw15port_s1_agent:rp_data -> router_004:sink_data
	wire          sw15port_s1_agent_rp_ready;                                             // router_004:sink_ready -> sw15port_s1_agent:rp_ready
	wire          sw15port_s1_agent_rp_startofpacket;                                     // sw15port_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          sw15port_s1_agent_rp_endofpacket;                                       // sw15port_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          sw07port_s1_burst_adapter_source0_valid;                                // sw07port_s1_burst_adapter:source0_valid -> sw07port_s1_agent:cp_valid
	wire  [112:0] sw07port_s1_burst_adapter_source0_data;                                 // sw07port_s1_burst_adapter:source0_data -> sw07port_s1_agent:cp_data
	wire          sw07port_s1_burst_adapter_source0_ready;                                // sw07port_s1_agent:cp_ready -> sw07port_s1_burst_adapter:source0_ready
	wire    [4:0] sw07port_s1_burst_adapter_source0_channel;                              // sw07port_s1_burst_adapter:source0_channel -> sw07port_s1_agent:cp_channel
	wire          sw07port_s1_burst_adapter_source0_startofpacket;                        // sw07port_s1_burst_adapter:source0_startofpacket -> sw07port_s1_agent:cp_startofpacket
	wire          sw07port_s1_burst_adapter_source0_endofpacket;                          // sw07port_s1_burst_adapter:source0_endofpacket -> sw07port_s1_agent:cp_endofpacket
	...
	wire    [4:0] hexrport_s1_burst_adapter_source0_channel;                              // hexrport_s1_burst_adapter:source0_channel -> hexrport_s1_agent:cp_channel
	...
	wire          sw15port_s1_burst_adapter_source0_valid;                                // sw15port_s1_burst_adapter:source0_valid -> sw15port_s1_agent:cp_valid
	wire  [112:0] sw15port_s1_burst_adapter_source0_data;                                 // sw15port_s1_burst_adapter:source0_data -> sw15port_s1_agent:cp_data
	wire          sw15port_s1_burst_adapter_source0_ready;                                // sw15port_s1_agent:cp_ready -> sw15port_s1_burst_adapter:source0_ready
	wire    [4:0] sw15port_s1_burst_adapter_source0_channel;                              // sw15port_s1_burst_adapter:source0_channel -> sw15port_s1_agent:cp_channel
	wire          sw15port_s1_burst_adapter_source0_startofpacket;                        // sw15port_s1_burst_adapter:source0_startofpacket -> sw15port_s1_agent:cp_startofpacket
	wire          sw15port_s1_burst_adapter_source0_endofpacket;                          // sw15port_s1_burst_adapter:source0_endofpacket -> sw15port_s1_agent:cp_endofpacket
	...
	wire          router_002_src_valid;                                                   // router_002:src_valid -> sw07port_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_002_src_data;                                                    // router_002:src_data -> sw07port_s1_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                                   // sw07port_s1_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [4:0] router_002_src_channel;                                                 // router_002:src_channel -> sw07port_s1_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                           // router_002:src_startofpacket -> sw07port_s1_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                             // router_002:src_endofpacket -> sw07port_s1_rsp_width_adapter:in_endofpacket
	wire          sw07port_s1_rsp_width_adapter_src_valid;                                // sw07port_s1_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [148:0] sw07port_s1_rsp_width_adapter_src_data;                                 // sw07port_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          sw07port_s1_rsp_width_adapter_src_ready;                                // rsp_demux_001:sink_ready -> sw07port_s1_rsp_width_adapter:out_ready
	wire    [4:0] sw07port_s1_rsp_width_adapter_src_channel;                              // sw07port_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          sw07port_s1_rsp_width_adapter_src_startofpacket;                        // sw07port_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          sw07port_s1_rsp_width_adapter_src_endofpacket;                          // sw07port_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          router_003_src_valid;                                                   // router_003:src_valid -> hexrport_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_003_src_data;                                                    // router_003:src_data -> hexrport_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                   // hexrport_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [4:0] router_003_src_channel;                                                 // router_003:src_channel -> hexrport_s1_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                           // router_003:src_startofpacket -> hexrport_s1_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                             // router_003:src_endofpacket -> hexrport_s1_rsp_width_adapter:in_endofpacket
	wire          hexrport_s1_rsp_width_adapter_src_valid;                                // hexrport_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [148:0] hexrport_s1_rsp_width_adapter_src_data;                                 // hexrport_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          hexrport_s1_rsp_width_adapter_src_ready;                                // rsp_demux_002:sink_ready -> hexrport_s1_rsp_width_adapter:out_ready
	wire    [4:0] hexrport_s1_rsp_width_adapter_src_channel;                              // hexrport_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire          hexrport_s1_rsp_width_adapter_src_startofpacket;                        // hexrport_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire          hexrport_s1_rsp_width_adapter_src_endofpacket;                          // hexrport_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire          router_004_src_valid;                                                   // router_004:src_valid -> sw15port_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_004_src_data;                                                    // router_004:src_data -> sw15port_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                   // sw15port_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [4:0] router_004_src_channel;                                                 // router_004:src_channel -> sw15port_s1_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                           // router_004:src_startofpacket -> sw15port_s1_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                             // router_004:src_endofpacket -> sw15port_s1_rsp_width_adapter:in_endofpacket
	wire          sw15port_s1_rsp_width_adapter_src_valid;                                // sw15port_s1_rsp_width_adapter:out_valid -> rsp_demux_003:sink_valid
	wire  [148:0] sw15port_s1_rsp_width_adapter_src_data;                                 // sw15port_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          sw15port_s1_rsp_width_adapter_src_ready;                                // rsp_demux_003:sink_ready -> sw15port_s1_rsp_width_adapter:out_ready
	wire    [4:0] sw15port_s1_rsp_width_adapter_src_channel;                              // sw15port_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	wire          sw15port_s1_rsp_width_adapter_src_startofpacket;                        // sw15port_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_003:sink_startofpacket
	wire          sw15port_s1_rsp_width_adapter_src_endofpacket;                          // sw15port_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_003:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                                  // cmd_mux_001:src_valid -> sw07port_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_001_src_data;                                                   // cmd_mux_001:src_data -> sw07port_s1_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                                  // sw07port_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                // cmd_mux_001:src_channel -> sw07port_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                                          // cmd_mux_001:src_startofpacket -> sw07port_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                            // cmd_mux_001:src_endofpacket -> sw07port_s1_cmd_width_adapter:in_endofpacket
	wire          sw07port_s1_cmd_width_adapter_src_valid;                                // sw07port_s1_cmd_width_adapter:out_valid -> sw07port_s1_burst_adapter:sink0_valid
	wire  [112:0] sw07port_s1_cmd_width_adapter_src_data;                                 // sw07port_s1_cmd_width_adapter:out_data -> sw07port_s1_burst_adapter:sink0_data
	wire          sw07port_s1_cmd_width_adapter_src_ready;                                // sw07port_s1_burst_adapter:sink0_ready -> sw07port_s1_cmd_width_adapter:out_ready
	wire    [4:0] sw07port_s1_cmd_width_adapter_src_channel;                              // sw07port_s1_cmd_width_adapter:out_channel -> sw07port_s1_burst_adapter:sink0_channel
	wire          sw07port_s1_cmd_width_adapter_src_startofpacket;                        // sw07port_s1_cmd_width_adapter:out_startofpacket -> sw07port_s1_burst_adapter:sink0_startofpacket
	wire          sw07port_s1_cmd_width_adapter_src_endofpacket;                          // sw07port_s1_cmd_width_adapter:out_endofpacket -> sw07port_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_002_src_valid;                                                  // cmd_mux_002:src_valid -> hexrport_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_002_src_data;                                                   // cmd_mux_002:src_data -> hexrport_s1_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                                  // hexrport_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                // cmd_mux_002:src_channel -> hexrport_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_002_src_startofpacket;                                          // cmd_mux_002:src_startofpacket -> hexrport_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                            // cmd_mux_002:src_endofpacket -> hexrport_s1_cmd_width_adapter:in_endofpacket
	...
	wire    [4:0] hexrport_s1_cmd_width_adapter_src_channel;                              // hexrport_s1_cmd_width_adapter:out_channel -> hexrport_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_003_src_valid;                                                  // cmd_mux_003:src_valid -> sw15port_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_003_src_data;                                                   // cmd_mux_003:src_data -> sw15port_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                  // sw15port_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> sw15port_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_003_src_startofpacket;                                          // cmd_mux_003:src_startofpacket -> sw15port_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                            // cmd_mux_003:src_endofpacket -> sw15port_s1_cmd_width_adapter:in_endofpacket
	wire          sw15port_s1_cmd_width_adapter_src_valid;                                // sw15port_s1_cmd_width_adapter:out_valid -> sw15port_s1_burst_adapter:sink0_valid
	wire  [112:0] sw15port_s1_cmd_width_adapter_src_data;                                 // sw15port_s1_cmd_width_adapter:out_data -> sw15port_s1_burst_adapter:sink0_data
	wire          sw15port_s1_cmd_width_adapter_src_ready;                                // sw15port_s1_burst_adapter:sink0_ready -> sw15port_s1_cmd_width_adapter:out_ready
	wire    [4:0] sw15port_s1_cmd_width_adapter_src_channel;                              // sw15port_s1_cmd_width_adapter:out_channel -> sw15port_s1_burst_adapter:sink0_channel
	wire          sw15port_s1_cmd_width_adapter_src_startofpacket;                        // sw15port_s1_cmd_width_adapter:out_startofpacket -> sw15port_s1_burst_adapter:sink0_startofpacket
	wire          sw15port_s1_cmd_width_adapter_src_endofpacket;                          // sw15port_s1_cmd_width_adapter:out_endofpacket -> sw15port_s1_burst_adapter:sink0_endofpacket
	...
	wire          sw07port_s1_agent_rdata_fifo_src_valid;                                 // sw07port_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] sw07port_s1_agent_rdata_fifo_src_data;                                  // sw07port_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          sw07port_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_001:in_0_ready -> sw07port_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                      // avalon_st_adapter_001:out_0_valid -> sw07port_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                       // avalon_st_adapter_001:out_0_data -> sw07port_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                      // sw07port_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                      // avalon_st_adapter_001:out_0_error -> sw07port_s1_agent:rdata_fifo_sink_error
	wire          hexrport_s1_agent_rdata_fifo_src_valid;                                 // hexrport_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] hexrport_s1_agent_rdata_fifo_src_data;                                  // hexrport_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          hexrport_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_002:in_0_ready -> hexrport_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                      // avalon_st_adapter_002:out_0_valid -> hexrport_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                       // avalon_st_adapter_002:out_0_data -> hexrport_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                      // hexrport_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                      // avalon_st_adapter_002:out_0_error -> hexrport_s1_agent:rdata_fifo_sink_error
	wire          sw15port_s1_agent_rdata_fifo_src_valid;                                 // sw15port_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] sw15port_s1_agent_rdata_fifo_src_data;                                  // sw15port_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          sw15port_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_003:in_0_ready -> sw15port_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                      // avalon_st_adapter_003:out_0_valid -> sw15port_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                       // avalon_st_adapter_003:out_0_data -> sw15port_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                      // sw15port_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                      // avalon_st_adapter_003:out_0_error -> sw15port_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_translator #(
		...
		.reset                  (sw07port_reset_reset_bridge_in_reset_reset),                             //                     reset.reset
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sw07port_s1_translator (
		.clk                    (pcie_hard_ip_0_pcie_core_clk_clk),           //                      clk.clk
		.reset                  (sw07port_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sw07port_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (sw07port_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (sw07port_s1_agent_m0_read),                  //                         .read
		.uav_write              (sw07port_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (sw07port_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (sw07port_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (sw07port_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (sw07port_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (sw07port_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (sw07port_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (sw07port_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (sw07port_s1_address),                        //      avalon_anti_slave_0.address
		.av_readdata            (sw07port_s1_readdata),                       //                         .readdata
		.av_write               (),                                           //              (terminated)
		.av_read                (),                                           //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sw15port_s1_translator (
		.clk                    (pcie_hard_ip_0_pcie_core_clk_clk),           //                      clk.clk
		.reset                  (sw07port_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sw15port_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (sw15port_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (sw15port_s1_agent_m0_read),                  //                         .read
		.uav_write              (sw15port_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (sw15port_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (sw15port_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (sw15port_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (sw15port_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (sw15port_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (sw15port_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (sw15port_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (sw15port_s1_address),                        //      avalon_anti_slave_0.address
		.av_readdata            (sw15port_s1_readdata),                       //                         .readdata
		.av_write               (),                                           //              (terminated)
		.av_read                (),                                           //              (terminated)
		.av_writedata           (),                                           //              (terminated)
		.av_begintransfer       (),                                           //              (terminated)
	...
	altera_merlin_master_agent #(
		...
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),                                       //       clk.clk
		.reset                 (sw07port_reset_reset_bridge_in_reset_reset),                             // clk_reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pcie_hard_ip_0_pcie_core_clk_clk),                //             clk.clk
		.reset                   (sw07port_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (sw07port_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (sw07port_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (sw07port_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (sw07port_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (sw07port_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (sw07port_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (sw07port_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (sw07port_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (sw07port_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (sw07port_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (sw07port_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (sw07port_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (sw07port_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (sw07port_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (sw07port_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (sw07port_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (sw07port_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (sw07port_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (sw07port_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (sw07port_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (sw07port_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (sw07port_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (sw07port_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (sw07port_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (sw07port_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (sw07port_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (sw07port_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (sw07port_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (sw07port_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (sw07port_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (sw07port_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (sw07port_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),               //                .error
		.rdata_fifo_src_ready    (sw07port_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sw07port_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (sw07port_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sw07port_s1_agent_rsp_fifo (
		.clk               (pcie_hard_ip_0_pcie_core_clk_clk),             //       clk.clk
		.reset             (sw07port_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (sw07port_s1_agent_rf_source_data),             //        in.data
		.in_valid          (sw07port_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (sw07port_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sw07port_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sw07port_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sw07port_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sw07port_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sw07port_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sw07port_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sw07port_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pcie_hard_ip_0_pcie_core_clk_clk),                //             clk.clk
		.reset                   (sw07port_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (sw15port_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (sw15port_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (sw15port_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (sw15port_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (sw15port_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (sw15port_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (sw15port_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (sw15port_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (sw15port_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (sw15port_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (sw15port_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (sw15port_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (sw15port_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (sw15port_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (sw15port_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (sw15port_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (sw15port_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (sw15port_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (sw15port_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (sw15port_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (sw15port_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (sw15port_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (sw15port_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (sw15port_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (sw15port_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (sw15port_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (sw15port_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (sw15port_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (sw15port_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (sw15port_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (sw15port_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (sw15port_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),               //                .error
		.rdata_fifo_src_ready    (sw15port_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sw15port_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (sw15port_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sw15port_s1_agent_rsp_fifo (
		.clk               (pcie_hard_ip_0_pcie_core_clk_clk),             //       clk.clk
		.reset             (sw07port_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (sw15port_s1_agent_rf_source_data),             //        in.data
		.in_valid          (sw15port_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (sw15port_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sw15port_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sw15port_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sw15port_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sw15port_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sw15port_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sw15port_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sw15port_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	pcihellocore_mm_interconnect_0_router_001 router_002 (
		.sink_ready         (sw07port_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (sw07port_s1_agent_rp_valid),                 //          .valid
		.sink_data          (sw07port_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (sw07port_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (sw07port_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),           //       clk.clk
		.reset              (sw07port_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcihellocore_mm_interconnect_0_router_001 router_004 (
		.sink_ready         (sw15port_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (sw15port_s1_agent_rp_valid),                 //          .valid
		.sink_data          (sw15port_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (sw15port_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (sw15port_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),           //       clk.clk
		.reset              (sw07port_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (sw07port_reset_reset_bridge_in_reset_reset),             // cr0_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) sw07port_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),                //       cr0.clk
		.reset                 (sw07port_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
		.sink0_valid           (sw07port_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (sw07port_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (sw07port_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (sw07port_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (sw07port_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (sw07port_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (sw07port_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (sw07port_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (sw07port_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (sw07port_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (sw07port_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (sw07port_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) sw15port_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),                //       cr0.clk
		.reset                 (sw07port_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
		.sink0_valid           (sw15port_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (sw15port_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (sw15port_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (sw15port_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (sw15port_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (sw15port_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (sw15port_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (sw15port_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (sw15port_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (sw15port_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (sw15port_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (sw15port_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),                //       clk.clk
		.reset              (sw07port_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.sink_ready         (sw07port_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (sw07port_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (sw07port_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (sw07port_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (sw07port_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (sw07port_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),                //       clk.clk
		.reset              (sw07port_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.sink_ready         (sw15port_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (sw15port_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (sw15port_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (sw15port_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (sw15port_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (sw15port_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (sw07port_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sw07port_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sw07port_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sw07port_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sw07port_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sw07port_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (sw15port_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sw15port_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sw15port_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sw15port_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sw15port_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sw15port_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (sw07port_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sw07port_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (sw07port_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (sw07port_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (sw07port_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sw07port_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (sw15port_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sw15port_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (sw15port_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (sw15port_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (sw15port_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sw15port_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (sw07port_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pcie_hard_ip_0_pcie_core_clk_clk),           // in_clk_0.clk
		.in_rst_0_reset (sw07port_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sw07port_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (sw07port_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (sw07port_s1_agent_rdata_fifo_src_ready),     //         .ready
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pcie_hard_ip_0_pcie_core_clk_clk),           // in_clk_0.clk
		.in_rst_0_reset (sw07port_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sw15port_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (sw15port_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (sw15port_s1_agent_rdata_fifo_src_ready),     //         .ready
